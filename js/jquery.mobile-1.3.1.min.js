...
(function( $, window, undefined ) {
	...
	$.event.special.swipe = {
		...
		horizontalDistanceThreshold: 120,  // Swipe horizontal displacement must be more than this.
...
$.widget( "mobile.panel", $.mobile.widget, {
	...
	_scrollIntoView: function( panelInnerHeight ) {
		if ( panelInnerHeight < $( window ).scrollTop() ) {
			//window.scrollTo( 0, 0 ); //Commeneted by CoolG onclick of panel going to page top
		}
	},
